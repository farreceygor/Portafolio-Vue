...
a {
    ...
    border-color: hsla(161, 66%, 31%, 0.895); /* Define el color del borde usando hsla */
...
a:hover {
    background-color: hsla(160, 78%, 35%, 0.806); /* Cambia el color de fondo al pasar el mouse sobre un enlace */
}
