...
const educacion = ref([
  {fecha: '2020', title: 'Curso de Python Principiantes', descripcion: 'Aprendizaje de las variables, condicionales, ciclos y funciones', enlace:'http:www.direccion.com'},
  {fecha: '2023', title: 'Curso de CiberSeguridad', descripcion: 'Habilidades para prevenir ataques y vulnerabilidades en dispositivos. Proteccion y cifrados de archivos.', enlace:'http:www.direccion.com'},
  {fecha: '2025', title: 'Tecnicatura Universitaria en Programacion', descripcion: 'Desarrollo de programas en distintos lenguajes, análisis y control de sistemas informáticos.', enlace:'http:www.direccion.com'}
]);
</script>
