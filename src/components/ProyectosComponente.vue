...
misProyectos.value = ([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        id: 1,
        src: proyecto1,
        titulo: "The Pseintsons(2025)",
        descripcion: "Creamos con nuestro grupo Print 'Estoy Cansado Jefe' una trivia en Pseint.",
    ...
    },
    {
        ...
        src: proyecto2,
        titulo: "JAVA D'OH!",
        descripcion: "Segundo proyecto de trivia con mi grupo Print 'Estoy cansado Jefe', esta vez en JAVA.",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/HotCode2025/Print-Estoy-Cansado-Jefe--Segundo-Semestre/tree/Tecnicatura/ProyectoFinal"
    }
])
...
.galeria {
    ...
    background: linear-gradient(-45deg, #048587, #138e9e, #6cbcb5, #5b959d);
